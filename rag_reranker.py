...
def create_llm_evaluator():
    ...
    system_prompt = """
        ROLE
        You are an Expert Editor and Quality Grader for a Q&A assistant specializing in Chameleon Cloud. You review first drafts of answers to questions yourself, then you review and perfect them.
